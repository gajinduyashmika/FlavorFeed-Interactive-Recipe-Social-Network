...
export const autoSeedIfEmpty = async () => {
  try {
    ...
    console.log('[AutoSeed] Database is empty. Seeding initial gourmet recipes and demo foodies...');
    ...
    console.log(`[AutoSeed] Seeded ${created.length} recipes and 3 demo foodies successfully!`);
  } catch (err) {
